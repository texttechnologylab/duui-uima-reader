...
from annatto_utils import Token
...
app = FastAPI(
    ...
    docs_url="/api",
    redoc_url=None,
    title="Annatto-Reader",
    description="Annatto Reader for TTLab TextImager DUUI",
    version="0.1",
...
def get_documentation() -> TextImagerDocumentation:
    ...
    documentation = TextImagerDocumentation(
        annotator_name=f"Annatto-Reader-Version: {settings.annatto_version}",
        version=str(settings.annatto_version),
...
if __name__ == "__main__":
    uvicorn.run("duui-annatto_reader:app", host="0.0.0.0", port=9714, workers=1)